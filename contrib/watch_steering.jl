...
# expects matrix output on 64730 and [y,x] vector output on 64731. Large
# camera frames may be spatially downsampled by udp_sink; normalized CoM
# coordinates still map correctly across the preview's complete field of view.
#
