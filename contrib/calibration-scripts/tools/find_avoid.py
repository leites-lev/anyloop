...
Usage:
    contrib/calibration-scripts/tools/find_avoid.py                 # settle 30 s, record 40 s, print lines
    contrib/calibration-scripts/tools/find_avoid.py --write         # ALSO write avoid_freqs into the configs
    contrib/calibration-scripts/tools/find_avoid.py --duration 60   # record longer (finer/less-noisy spectrum)
    contrib/calibration-scripts/tools/find_avoid.py --settle 0      # beam already parked; record immediately
    contrib/calibration-scripts/tools/find_avoid.py --aylp rec.aylp # analyse an existing recording, no capture
    contrib/calibration-scripts/tools/find_avoid.py --no-park       # don't add a piplate stanza (FSM left as-is)
